...
func RegisterOrderServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrderServiceServer) error {
	...
	mux.Handle("GET", pattern_OrderService_GetOrders_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/order.v1.OrderService/GetOrders", runtime.WithHTTPPathPattern("/v1/orders"))
		if err != nil {
		...
		forward_OrderService_GetOrders_0(annotatedContext, mux, outboundMarshaler, w, req, response_OrderService_GetOrders_0{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_OrderService_CreateOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_OrderService_CreateOrder_0(annotatedContext, mux, outboundMarshaler, w, req, response_OrderService_CreateOrder_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterOrderServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrderServiceClient) error {
	...
	mux.Handle("GET", pattern_OrderService_GetOrders_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/order.v1.OrderService/GetOrders", runtime.WithHTTPPathPattern("/v1/orders"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_OrderService_GetOrders_0 struct {
	proto.Message
}

func (m response_OrderService_GetOrders_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetOrdersResponse)
	return response.Orders
}

type response_OrderService_CreateOrder_0 struct {
	proto.Message
}

func (m response_OrderService_CreateOrder_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*CreateOrderResponse)
	return response.Order
}

var (
	pattern_OrderService_GetOrders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "orders"}, ""))
